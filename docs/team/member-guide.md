...
This page holds resources for members of the Jupyter Kernels Council.
...
* [**The Jupyter Kernels Team Compass**](team-compass-kernels)
  ...
  etc.
* [**The Jupyter Kernels Team Compass issues**](team-compass-kernels/issues)
...
1. **"Watch" the [`team-compass` repository](team-compass-kernels)**
...
2. **Stay up-to-date on team meetings**. You can find a notes from previous meetings pinned at
   the [top of the `team-compass` issues page](team-compass-kernels/issues).
...
* **Use your best judgment**. As a member of the Jupyter Kernels Council, we trust
